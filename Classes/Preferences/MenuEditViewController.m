...
//    UITextRange* range = commandTextView.selectedTextRange;
//    NSInteger location = [commandTextView offsetFromPosition:commandTextView.beginningOfDocument toPosition:range.start];
//    return location;
//    return [commandTextView selectedTextRange].location;
//}
