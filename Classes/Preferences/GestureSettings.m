...
- (id)initWithCoder:(NSCoder *)decoder {
  self = [super init];
  return [self initStuff: decoder : self];
}

- (id)initStuff:(NSCoder *)decoder : (GestureSettings*) s {
    if (s != nil) {
        gestureItems = [[NSMutableArray alloc] init];
        [s addGestureItem:kGestureSingleDoubleTap withCoder:decoder];
        [s addGestureItem:kGestureDoubleDoubleTap withCoder:decoder];
        [s addGestureItem:kGestureSwipeUp withCoder:decoder];
        [s addGestureItem:kGestureSwipeDown withCoder:decoder];
        [s addGestureItem:kGestureSwipeLeft withCoder:decoder];
        [s addGestureItem:kGestureSwipeRight withCoder:decoder];
        [s addGestureItem:kGestureSwipeLeftUp withCoder:decoder];
        [s addGestureItem:kGestureSwipeLeftDown withCoder:decoder];
        [s addGestureItem:kGestureSwipeRightUp withCoder:decoder];
        [s addGestureItem:kGestureSwipeRightDown withCoder:decoder];
